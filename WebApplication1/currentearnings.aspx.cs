...
namespace WebApplication1
{
    ...
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            dataCommand.CommandText = ("select * from summerearnings2015");
            dataCommand.CommandText = ("insert into summerearnings2015 ( Date, [Money Earned], [Money Saved], [Money Used As Taxes],[ID] ) values ('" + @Date + "', '" + @Money_Earned + "', '" + @Money_Saved + "', '" + @Money_Used_As_Taxes + "','"+ID+"')"); 
