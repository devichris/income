<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="stat2016.aspx.cs" Inherits="WebApplication1.stats" %>
...
<body>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EmptyDataText="There are no data records to display." CellPadding="4" ForeColor="#333333" GridLines="None" style="text-align: center; position: relative; top: 90px; left: 196px; height: 268px; width: 582px">
         ...
         <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:neeneeConnectionString %>" ProviderName="<%$ ConnectionStrings:neeneeConnectionString.ProviderName %>" SelectCommand="SELECT [Earned Total] AS Earned_Total FROM [yeartotal2016]"></asp:SqlDataSource>
         <br />
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:neeneeConnectionString %>" ProviderName="<%$ ConnectionStrings:neeneeConnectionString.ProviderName %>" SelectCommand="SELECT [Total Money Earned] AS Total_Money_Earned, [Month] FROM [yearlyearnings2016]">
         ...
         <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:neeneeConnectionString %>" ProviderName="<%$ ConnectionStrings:neeneeConnectionString.ProviderName %>" SelectCommand="SELECT [Save Total] AS Save_Total FROM [savetotal2016]"></asp:SqlDataSource>
         <br />
         ...
         <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:neeneeConnectionString %>" ProviderName="<%$ ConnectionStrings:neeneeConnectionString.ProviderName %>" SelectCommand="SELECT [Tax] FROM [taxtotal2016]"></asp:SqlDataSource>
         <br />
         <br />
         <br />
         <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:neeneeConnectionString %>" ProviderName="<%$ ConnectionStrings:neeneeConnectionString.ProviderName %>" SelectCommand="SELECT [Earned Total] AS Earned_Total, [Saved Total] AS Saved_Total, [Taxed Total] AS Taxed_Total FROM [yeartotal2016]"></asp:SqlDataSource>
         <br />
         <br />
         <br />
         <br />
         ...
         <br />
         <br />
         <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">Click Here To Update</asp:LinkButton>
             </span>
        </div>
